...
2026-09-12，根已将P_model统一确定性模拟计费写入73的§1/§9.1/§12，并在§10补L22的ECBS单位层/代价不可达分支证明及整批计数边界，随后更新W25/W29/W39并在§14加入原有主张的贡献与反证表。最新稿SHA256 `64ae0e0366ff6f98c4b3d5a4341bd13a52b869f2ecb2fe14af62f438e304e751`，226801 bytes/709 LF。6714761及815aa02是本轮中间字节，已被后续编辑替代；原9e06199仍为本轮子报告实际输入身份，不能把其意见冒称审过新稿。
...
| 公开来源静态资格 | 四必需类别的引用/对象/parser与已声明合法谓词；来源使用依据独立保留 | L22完成；因旧交接禁止读公开输入，根已提出有限只读授权问题，未获回复前不读 |
| delay出处与共享故障语义 | 明确原矩阵与ACTUATOR映射或显式分域，并一致解释source_id/权重 | L22已定位，尚未自行假设映射或改总体 |
